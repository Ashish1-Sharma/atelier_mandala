...
import '../../data/home_auth_store.dart';
  ...
  Future<void> showCustomDialog(BuildContext context){
    return showDialog(
      ...
      title: Text("ALERT",style: AppTextStyles.bodyMain18(color: Colors.black),),actions: [
    ...
    ],content: Text("Are you sure want to logout ?",style: AppTextStyles.bodyMain16(color: Colors.black),),),);
  }
