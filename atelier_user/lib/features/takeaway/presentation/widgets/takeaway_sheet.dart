...
class TakeawaySheet extends StatefulWidget {
  final TakeawayModel model;
  const TakeawaySheet({super.key,required this.model});

  @override
  State<TakeawaySheet> createState() => _TakeawaySheetState();
}

class _TakeawaySheetState extends State<TakeawaySheet> {
